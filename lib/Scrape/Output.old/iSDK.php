 ...
 * @license   MIT Licens
 * @version   [0.0.1]
 * @link      http://github.com/elliotboney
 */

namespace iSDK;

if (!function_exists('xmlrpc_encode_entitites')) {
    include "lib/xmlrpclib/xmlrpc.inc";
}
 ...
 * @global string $GLOBALS['appName']
 */
$GLOBALS['appName'] = 'vis91490';

/**
 * Infusionsoft Application API Key
 * @global string $GLOBALS['key']
 */
$GLOBALS['key'] = '0b50ffe86e929e39970c51b2185c4419';
// $GLOBALS['encKey'] = php_xmlrpc_encode($GLOBALS['key']);
// $GLOBALS['url'] = 'https://'.$GLOBALS['appName'].'.infusionsoft.com/api/xmlrpc';
